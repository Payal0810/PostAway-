# PostAway-
A full-featured social media backend built with Node.js, Express, MongoDB, and JWT authentication — including posts, comments, likes, friendships, and secure user management.
